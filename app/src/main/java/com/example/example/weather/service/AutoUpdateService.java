package com.example.example.weather.service;
...
import com.example.example.weather.receiver.AutoUpdateReceiver;
    ...
    private void updateWeather() {
        ...
        HttpUtil.sendHttpGetRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                Log.d("TAG", response);
                ResponseHandlerUtil.handleWeatherResponse(AutoUpdateService.this, response);
            }
